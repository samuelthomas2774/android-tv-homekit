...
public class SleepDiscoveryMode extends EnumCharacteristic implements EventableCharacteristic {
    public static final int NOT_DISCOVERABLE = 0;
    public static final int ALWAYS_DISCOVERABLE = 1;
    ...
    public SleepDiscoveryMode(
        Supplier<CompletableFuture<Integer>> getter,
        Consumer<HomekitCharacteristicChangeCallback> subscriber,
        Runnable unsubscriber
    ) {
        super("000000E8-0000-1000-8000-0026BB765291", false, true, "Sleep Discovery Mode", 1);
    ...
    public SleepDiscoveryMode(int value) {
