...
public class VariationSpeed extends IntegerCharacteristic implements EventableCharacteristic {
    ...
    public VariationSpeed(
        Supplier<CompletableFuture<Integer>> getter,
        ExceptionalConsumer<Integer> setter,
        Consumer<HomekitCharacteristicChangeCallback> subscriber,
        Runnable unsubscriber
    ) {
        super("CA7897C6-4B46-448D-AF68-29C686B730F4", true, true, "Colour Variation Speed", 0, 255, "");
